 ...
 * @method assertInstanceOf($str1, $str2)
 */
trait StringyHelperTrait
{
    /**
    ...
    public function removeLeftProvider()
    {
        return array(
            ...
            array('oo bar', 'foo bar', String::create('foo bar')->first(1), 'UTF-8'),
            array('oo bar', 'foo bar', String::create('foo bar')->at(0), 'UTF-8'),
            array('fòô bàř', 'fòô bàř', '', 'UTF-8'),
    ...
    public function removeRightProvider()
    {
        return array(
            ...
            array('foo ba', 'foo bar', String::create('foo bar')->last(1), 'UTF-8'),
            array('foo ba', 'foo bar', String::create('foo bar')->at(6), 'UTF-8'),
            array('fòô bàř', 'fòô bàř', '', 'UTF-8'),

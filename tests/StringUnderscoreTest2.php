 ...
 */
class StringUnderscoreTest extends SupportTestCase
{
    ...
    {
        $this->assertEquals(4, String::count('four'));
    }

    public function testAppend()
    {
        $appended = String::append('test', 'append');
        $this->assertEquals('testappend', $appended);
    }
